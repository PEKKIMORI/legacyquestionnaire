      ...
      try {
        ...
        if (querySnapshot.empty) {
          ...
          if (responseDoc) {
            ...
            const minervaVibes: Record<string, string[]> = {
              Civic: ["Community-Oriented", "Service-Minded", "Collaborative"],
              Legion: ["Resilient", "Bold", "Loyal"],
              Liberty: ["Independent", "Free-Spirited", "Self-Driven"],
              North: ["Visionary", "Innovative", "Forward-Thinking"],
              Tower: ["Courageous", "Adventurous", "Growth-Seeker"],
              Lands: ["Grounded", "Practical", "Rooted"],
              Ocean: ["Creative", "Imaginative", "Fluid"],
              Plaza: ["Supportive", "Sociable", "Connector"],
              Reserve: ["Thoughtful", "Reflective", "Calm"],
              Vista: ["Curious", "Inquisitive", "Explorer"],
              Pier: ["Adventurous", "Loyal", "Steadfast"],
              Cable: ["Connected", "Networker", "Inclusive"],
              Chronicle: ["Goal-Oriented", "Historian", "Documenter"],
              Pyramid: ["Meditative", "Steady", "Builder"],
              Field: ["Open-minded", "Team-Player", "Nurturer"],
              Gate: ["Welcoming", "Principled", "Protector"],
              Labyrinth: ["Mysterious", "Risk-Taker", "Explorer"],
              Laurel: ["Connected", "Balanced", "Harmonizer"],
              Mason: ["Crafty", "Builder", "Persistent"],
              Circuit: ["Innovative", "Technical", "Problem-Solver"],
              Eureka: ["Enlightened", "Creative", "Inventive"],
              Hunter: ["Focused", "Resourceful", "Survivor"],
              Mission: ["Determined", "Leader", "Supportive"],
              Octagon: ["Strategic", "Analytical", "Planner"],
            };
